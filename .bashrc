...
safe_term=${TERM//[^[:alnum:]]/?}   # sanitize TERM match_lhs=""
...
alias dw="sudo rfkill block 0"

alias r="ranger"
alias e="exit"
alias c="clear"

alias mm='sudo mount /dev/sda4 /mnt/manjaro_hdd'
alias mn='sudo mount /dev/sda7 /mnt/med'

#Building react-dash component and running it
alias dr="npm run build && python usage.py"
...
#export PS1="\[\e[0;32m\][Pacific \W]\$\e[00m "
#PS1="\[\e[32m\][Pacific \[\e[m\]\[\e[36m\]\W\[\e[m\]\[\e[32m\]]$(__git_ps1 "(%s)")\$\[\e[m\] "
